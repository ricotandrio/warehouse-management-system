      ...
      <tr>
        <td class="whitespace-nowrap px-4 py-4 text-sm font-medium">
          <div>
            ...
            <h2 class="font-medium text-gray-500 line-clamp-1 ">
        ...
        <td class="mt-4 flex flex-row items-center justify-start text-sm">
          ...
          <div class="ml-4">
            ...
            >
              ...
              <button
                type="submit"
                class="flex hover:opacity-60 flex-row items-center justify-center bg-red-500 py-2 pl-4 pr-5 text-white"
              >
                <svg
                  width="16"
                  height="16"
